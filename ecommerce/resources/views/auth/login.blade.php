...
<link rel="stylesheet" type="text/css" href="{{ asset('public/frontend/styles/contact_responsive.css')}}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-1" style="border: 1px solid  #cccc; padding: 20px; border-radius: 25px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('login')}}" id="contact_form" method="POST">
                            ...
                            <input type="text" class="form-control form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" aria-describedby="emailHelp" required="">
                            @error('email')
            ...
            <a href="{{ route('password.request') }}">*I Forgot my Password</a><br><br>
                        <button type="submit" class="btn btn-primary btn-block"><i class="fab fa-facebook-square" aria-hidden="true"></i> Login with Facebook</button>
                       <a href="{{ url('/auth/redirect/google') }}" class="btn btn-danger btn-block"><i class="fab fa-google" aria-hidden="true"></i> Login with Google</a>
                ...
                <div class="col-lg-5 offset-lg-1" style="border: 1px solid #cccc; padding: 20px; border-radius: 25px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('register')}}" id="contact_form" method="POST">
                            ...
                            <input type="email" class="form-control form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" aria-describedby="emailHelp" required="" placeholder="Enter Your Email">
                            </div>
                          <div class="form-group">
                            <label for="exampleInputEmail1">Password</label>
