          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Image Two (Main Thumbnail): <span class="tx-danger">*</span></label><br>
                  <label class="custom-file">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Image Three (Main Thumbnail): <span class="tx-danger">*</span></label><br>
                  <label class="custom-file">
