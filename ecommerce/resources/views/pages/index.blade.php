                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    ...
                                    <div class="trends_content">
                                        ...
                                        @endif
                                        <a href="" class="btn btn-danger btn-sm">Add to Cart
                                        </a>
                ...
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        ...
                        <div class="newsletter_content clearfix">
                            <form action="{{ route('store.newsletters')}}" method ="post" class="newsletter_form">
                                @csrf
...
<div class="modal fade" id="cartmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLavel" aria-hidden="true">
  ...
  <li class="list-group-item">Stock: <span class="badge" style="background: green; color: white;">Availaible</span></li>
</ul>
            </div>
