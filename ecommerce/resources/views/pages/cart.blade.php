						...
						<div class="cart_items">
							<ul class="cart_list">
								...
								<li class="cart_item clearfix">
									<div class="cart_item_image text-center"><br><img src="{{ asset($row->options->image) }}" style ="height: 70px; width: 70px;"alt=""></div>
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										...
										<div class="cart_item_total cart_info_col">
											...
											<a href="{{ url('remove/cart/'.$row->rowId) }}" class="btn btn-sm btn-danger"><i class="fas fa-times"></i></a>
										</div>
									</div>
								</li>
