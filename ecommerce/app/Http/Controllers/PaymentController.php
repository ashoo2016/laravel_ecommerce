...
class PaymentController extends Controller
{
 ...
 public function StripeCharge(Request $request){
		...
		\Stripe\Stripe::setApiKey('sk_test_51G1B5jH4CvwKJEiwFFMG7Y8HCkuJ3qpQV5JSRN8NMYPLRcPwAl3QH5scQdsq7pMnxiDWmVfBpq90KqzqliaqYqMD00blxIUWbf');
...
public function OnCash(Request $request){
    ...
    public function RequestReturn($id){
    	...
    	$notification=array(
                        'messege'=>'Return  Request Successfully Done',
                        'alert-type'=>'success'
                         );
